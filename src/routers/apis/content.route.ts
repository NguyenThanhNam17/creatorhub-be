...
class ContentRoute extends BaseRoute {
  ...
  customRouting() {
    this.router.get(
      "/getListContent/:id",
      this.authentication,
      this.route(this.getListContent),
    );
    this.router.get(
      "/getOneContent/:id",
      this.authentication,
      this.route(this.getOneContent),
    );
    this.router.post(
      "/createContent",
      this.authentication,
      this.route(this.createContent),
    );
    this.router.post(
      "/deleteContent/:id",
      this.authentication,
      this.route(this.deleteContent),
    );
    this.router.post(
      "/updateContent/:id",
      this.authentication,
      this.route(this.updateContent),
    );
  }
  ...
  async getListContent(req: Request, res: Response) {
    let { id } = req.params;
